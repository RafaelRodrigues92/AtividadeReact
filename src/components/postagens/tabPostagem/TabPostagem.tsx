            ...
            <TabContext value={ value }>
                ...
                <AppBar position="static" className='appbar'>
                    <Tabs centered indicatorColor="secondary" onChange={ handleChange }>
                        <Tab className="textotab" label="Todas as postagens" value="1"  />
                        <Tab className="textotab" label="Sobre-nós" value="2" />
                    </Tabs>
                </AppBar>

                <TabPanel value="1" className='tabpostagem' >
